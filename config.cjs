...
const config = {
  SESSION_ID: process.env.SESSION_ID || "MASTER-MD&mesXRnyf",
  ...
  OWNER_NAME: process.env.OWNER_NAME || "𝐃𝐔𝐋𝐀𝐍𝐉𝐀𝐍𝐀 𝐑𝐀𝐉𝐀𝐏𝐀𝐊𝐒𝐇𝐀",
  OWNER_NUMBER: process.env.OWNER_NUMBER || "94703074393",
